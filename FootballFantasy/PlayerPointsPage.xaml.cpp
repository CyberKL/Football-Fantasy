#include "pch.h"
#include "PlayerPointsPage.xaml.h"
#if __has_include("PlayerPointsPage.g.cpp")
#include "PlayerPointsPage.g.cpp"
#endif
#include "Presenter.h"
...
{
    int32_t PlayerPointsPage::MyProperty()
    {
        throw hresult_not_implemented();
    }

    void PlayerPointsPage::MyProperty(int32_t /* value */)
    {
        throw hresult_not_implemented();
    }
}
...
void winrt::FootballFantasy::implementation::PlayerPointsPage::Page_Loaded(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    unordered_map<int, struct UiFootballer> footballers;
    int captainId;
    int viceCaptainId;
    footballers = Presenter::getInstance()->loadTeamPointsPage();
